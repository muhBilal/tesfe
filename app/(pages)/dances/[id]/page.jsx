...
export default function page({params}) {
    ...
    const shuffleData = async (dances) => {
        if (dances) {
            const shuffled = [...dances]; // Create a shallow copy of the dances array
                                    ...
                                    >
                                        <div className={`w-full pr-3 px-6`}>
                                            <div className={`flex gap-5 items-center mb-3`}>
                                                ...
                                                <h1 className={`text-gray-400`}>{danceData.createdAt}</h1>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div className={`text-gray-500 text-sm`}
                                                 dangerouslySetInnerHTML={{__html: dance.desc}}/>
                                        </div>
                                    </div>
