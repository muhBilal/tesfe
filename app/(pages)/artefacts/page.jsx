...
export default function page() {
  ...
  const fetchData = async () => {
    const res = await axios.get(
      process.env.NEXT_PUBLIC_API + "/province/artefacts"
    );
    setArtefacts(res.data.data);
        ...
        <div className={`container`}>
          ...
          <section className="mt-5">
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-7`}>
              ...
              {artefacts.map((artefac, index) => (
                <div>
                  <img
                    src={artefac.image_thumbnail}
                    alt="animals"
                  ...
                  <div>
                    ...
                    <h5 className={`text-gray-500 text-lg`}>{artefac.desc}</h5>
